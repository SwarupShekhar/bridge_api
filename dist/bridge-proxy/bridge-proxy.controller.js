...
var BridgeProxyController_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.BridgeProxyController = void 0;
const common_1 = require("@nestjs/common");
const bridge_proxy_service_1 = require("./bridge-proxy.service");
const clerk_auth_service_1 = require("./clerk-auth.service");
let BridgeProxyController = BridgeProxyController_1 = class BridgeProxyController {
    constructor(bridgeProxyService, clerkAuthService) {
        ...
        this.logger = new common_1.Logger(BridgeProxyController_1.name);
    }
    async updateLastActive(body, authHeader) {
    ...
    async syncCefr(body, authHeader) {
        const clerkId = await this.clerkAuthService.verifyTokenAndGetUserId(authHeader);
...
exports.BridgeProxyController = BridgeProxyController;
__decorate([
...
], BridgeProxyController.prototype, "updateLastActive", null);
__decorate([
    (0, common_1.Post)('sync-cefr'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Headers)('authorization')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], BridgeProxyController.prototype, "syncCefr", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], BridgeProxyController.prototype, "incrementStreak", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], BridgeProxyController.prototype, "addPracticeMinutes", null);
exports.BridgeProxyController = BridgeProxyController = BridgeProxyController_1 = __decorate([
